<div class="row">
        ...
        <div class="card card-stats">
            ...
            <div class="card-footer">
                <div class="stats">
                    ...
                    <a href="{{route('skills.index')}}" class="warning-link" style="font-weight: bold">All Skills</a>
                </div>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
        <div class="card card-stats">
            ...
            <div class="card-footer">
                <div class="stats">
                    <a href="{{route('tags.index')}}" class="warning-link" style="font-weight: bold">All Tags</a>
                </div>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
        <div class="card card-stats">
            ...
            <div class="card-footer">
                <div class="stats">
                    <a href="{{route('videos.index')}}" class="warning-link" style="font-weight: bold">Check Videos</a>
                </div>
            </div>
        </div>
    </div>
